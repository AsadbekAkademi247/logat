                        ...
                        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                <div class="overflow-hidden p-3">
                                    ...
                                    <form class="p-6" @submit.prevent="form.post(route('loyihe.store'))">
                                        <div class="mb-6">
                                            <label for="success"
                                        ...
                                        <div class="mb-6">
                                            <label for="success"
                                                   class="block mb-2 text-sm font-medium text-green-700 dark:text-green-500">Descriptions</label>
                                        ...
                                        <p v-if="form.errors.title" id="standard_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400"><span class="font-medium">title Bo'sh</span> </p>
                                        <p v-if="form.errors.descriptions" id="standard_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400"><span class="font-medium">descriptions Bo'sh</span> </p>
